...
@Component
public class ProfileCreateValidator implements Validator {
    @Override
    public boolean supports(Class<?> clazz) {
        return ProfileImageEditForm.class.isAssignableFrom(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {
    	ProfileImageEditForm form = (ProfileImageEditForm)target;
        // 画像ファイルチェック
